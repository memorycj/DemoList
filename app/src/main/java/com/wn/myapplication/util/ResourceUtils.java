...
public class ResourceUtils {
    ...
    public static boolean copyFromAssets(String from, String to) {
        boolean r = false;
        BufferedSource source = null;
        BufferedSink sink = null;
        try {
            source = Okio.buffer(Okio.source(getContext().getAssets().open(from)));
            sink = Okio.buffer(Okio.sink(new File(to)));
